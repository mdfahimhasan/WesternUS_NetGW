...
months = (1, 12)
gee_grid_shape = '../../Data_main/shapefiles/Western_US_ref_shapes/WestUS_gee_grid.shp'
data_download_dir = '../../Data_main/Raster_data'
download_all_datasets(year_list=years, month_range=months, grid_shape=gee_grid_shape,
...
skip_terraclimate_et_processing = True
...
run_all_preprocessing(skip_cdl_cropland_processing=skip_cdl_cropland_processing, cdl_already_masked=cdl_already_masked,
                      ...
                      skip_terraclimate_et_processing=skip_terraclimate_et_processing,
