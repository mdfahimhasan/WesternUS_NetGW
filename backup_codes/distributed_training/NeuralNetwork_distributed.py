...
def model_train_distributed_T(train_data, observed_data_csv, n_epochs,
    ...
    for epoch in n_epoch:
        ...
        for step, Xs in enumerate(train_dataloader):  # Xs is already standardized in execute_dataloader()
            ...
            # backpropagation
            rmse_loss = torch.sqrt(mse_func(Y, T))  # calculate_rmse of standardized obsv and predicted outputs,
            # converting mse to calculate_rmse loss
        ...
        # printing standardized calculate_rmse loss in training
